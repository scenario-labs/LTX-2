...
class ICLoraPipeline:
    ...
    def __call__(  # noqa: PLR0913
        ...
        Args:
            ...
            negative_prompt: Optional negative prompt for CFG guidance.
            num_inference_steps: Number of inference steps (for CFG mode).
            video_guider_params: Optional guider params for video CFG.
            audio_guider_params: Optional guider params for audio CFG.
            callback: Optional progress callback invoked as callback(step, total_steps).
